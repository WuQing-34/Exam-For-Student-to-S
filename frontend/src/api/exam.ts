...
export const studentExamApi = {
  ...
  getExamContent(examId: number) {
    return api.get<ApiResponse<{
      ...
      status: string
      savedAnswers: Array<{ questionId: number; answer: string }>
  ...
  /** 保存考试草稿答案（不提交） */
  saveDraft(examId: number, answers: Array<{ questionId: number; answer: string }>) {
    return api.post<ApiResponse<null>>(`/student/exams/${examId}/save`, { answers })
  },
